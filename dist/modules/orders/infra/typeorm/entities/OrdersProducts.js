...
var OrdersProducts = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Order_1.default; }, function (order) { return order.order_products; }),
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Product_1.default; }, function (product) { return product.order_products; }),
