...
var OrdersProducts_1 = __importDefault(require("../entities/OrdersProducts"));
var OrdersRepository = /** @class */ (function () {
    function OrdersRepository() {
        this.ormRepository = (0, typeorm_1.getRepository)(Order_1.default);
    }
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        orderProducts = products.map(function (product) {
                            var orderProduct = new OrdersProducts_1.default();
